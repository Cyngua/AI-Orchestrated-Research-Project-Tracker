...
python pubmed.py --topic "abdominal aortic aneurysm" --year 2024 --retmax 50 --out sample_data/aaa_2024.json
python pubmed.py --topic "peripheral arterial disease" --year 2023 --out sample_data/pad_2023.json
python pubmed.py --topic "carotid artery stenosis" --year 2024 --out sample_data/cas_2024.json
'''
